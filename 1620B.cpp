...
void solve(int t) {
	...
	while(t--) {
		...
		// int out = max(h*(h1_arr[h1-1]-h1_arr[0]), h*(h2_arr[h2-1]-h2_arr[0]));
		ll out = max_4(w*(w1_arr[w1-1]-w1_arr[0]), w*(w2_arr[w2-1]-w2_arr[0]), h*(h1_arr[h1-1]-h1_arr[0]), h*(h2_arr[h2-1]-h2_arr[0]));
		cout<<out<<endl;
	}
}
